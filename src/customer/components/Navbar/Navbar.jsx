        ...
        <nav className='px-5 z-50 py-[.8rem] bg-[#e91e63] lg:px-20 flex justify-between'>
            <div className='flex items-center space-x-4'>
                <div className='lg:mr-10 cursor-pointer flex items-center space-x-4' onClick={() => navigate("/")}>
                    <li className='logo font-semibold text-gray-300 text-2xl'>Yummy Food</li>
            ...
            <div className='flex items-center space-x-2'>
                ...
                {true ? <span id="basic-button"
                    ...
                    aria-haspopup="true"
                    aria-expanded={openMenu ? 'true' : undefined} onClick={false ? handleOpenMenu : navigateToProfile}
                ...
                <IconButton onClick={()=>navigate("/cart")}>
                    <ShoppingCartCheckoutIcon sx={{ fontSize: "1.5rem" }} />
                </IconButton>
